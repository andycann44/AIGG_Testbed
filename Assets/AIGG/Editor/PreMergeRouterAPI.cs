...
namespace Aim2Pro.AIGG {
  public static class PreMergeRouterAPI {
    public static void Route(string json) {
      ...
      EditorGUIUtility.systemCopyBuffer = json; Debug.Log("[PreMergeRouterAPI] No Pre-Merge window; JSON copied.");
    }
    ...
    static bool Call(string tname, string mname, string arg){
      foreach (var asm in AppDomain.CurrentDomain.GetAssemblies()){
        try { var t=asm.GetType(tname); if (t==null) continue;
          var m=t.GetMethod(mname, System.Reflection.BindingFlags.Public|System.Reflection.BindingFlags.Static);
          if (m==null) continue; m.Invoke(null, new object[]{arg}); return true; } catch {}
      } return false;
    }
  }
}
