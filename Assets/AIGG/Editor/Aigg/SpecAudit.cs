...
namespace Aim2Pro.AIGG {
  public static class SpecAudit {
    ...
    public static List<string> FindMissingCommands(string canonicalJson) {
      var missing = new List<string>(); var used = ExtractActions(canonicalJson); var known = LoadKnownCommands();
    ...
    private static List<string> ExtractActions(string canonicalJson) {
      var list = new List<string>(); if (string.IsNullOrEmpty(canonicalJson)) return list;
